...
class CacheManager:
    ...
    def __init__(self,
        ...
        # ------------------------
        self.scanner_config = {
            "parallel": os.environ.get("OPT_PARALLEL", "1") == "1",
            "max_workers": int(os.environ.get("OPT_MAX_WORKERS", "8")),
...
class OptionData(CacheManager):
    def __init__(self):
        super().__init__("OptionData Cache","data/option_data/option_data.json",ttl_days=1)
...
class Caches:
    ...
    def all_autosave_loops(self):
        return [
            ...
            (self.option_data.autosave_loop, "Option Data Autosave")
        ]
